...
async function seed() {
        ...
        await FoodItem.create({name: "Chicken Nuggets", type: "appetizer", description: "10 Pc.", price: 4.50, imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Chicken_Nuggets.jpg/220px-Chicken_Nuggets.jpg"})
